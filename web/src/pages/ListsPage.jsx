...
import { useLists } from "../hooks/index.js";
import { ListAdd, ListItem } from "../components/index.js";
...
export default function ListPage() {
  ...
  const { handleSubmit, handleDelete, listName, setListName, lists } =
    useLists(navigate);
  return (
    <div
      data-page="completed"
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="task-list-container bg-white/10 rounded-2xl p-6 border border-white/20">
              ...
              <div className="space-y-3 h-[383px] overflow-y-auto">
                {lists.length === 0 ? (
