...
--
-- Host: localhost    Database: taskprose_db
-- ------------------------------------------------------
...
CREATE TABLE `activity_logs` (
  ...
  KEY `fk_log_todo` (`todo_id`),
  CONSTRAINT `fk_log_todo` FOREIGN KEY (`todo_id`) REFERENCES `todos` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `attachments` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_att_todo` (`todo_id`),
  CONSTRAINT `fk_att_todo` FOREIGN KEY (`todo_id`) REFERENCES `todos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `comments` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_com_todo` (`todo_id`),
  KEY `fk_com_user` (`user_id`),
  CONSTRAINT `fk_com_todo` FOREIGN KEY (`todo_id`) REFERENCES `todos` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `notifications` (
  ...
  CONSTRAINT `notifications_chk_1` CHECK (json_valid(`payload`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `todos` (
  ...
  `status` enum('planned','in_progress','completed','archived') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'in_progress',
  `priority` enum('normal','important') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'normal',
  `due_date` datetime DEFAULT NULL,
  `alarm_time` datetime DEFAULT NULL,
  `recurrence` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2026-06-11 17:22:06
