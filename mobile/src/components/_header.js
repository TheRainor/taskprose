import { View, Text, Image } from "../libs/index";
...
export default function Header() {
  ...
  return (
    <View className="h-[14%] w- bg-indigo-950 flex-row items-center self-center">
      <View className="mt-[10%] ml-[5%] h-[45%] w-[13%] p-3 rounded-xl items-center justify-center bg-white/70">
        <Image source={Logo} resizeMode="contain" className="h-full w-full" />
      </View>
